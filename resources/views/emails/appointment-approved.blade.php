...
<head>
    ...
    <style>
        ...
        .badge-approved { display: inline-block; background: #22c55e; color: white; padding: 4px 16px; border-radius: 20px; font-size: 14px; font-weight: bold; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Your appointment has been <strong>approved</strong> by Dr. {{ $doctor->name }}.</p>
